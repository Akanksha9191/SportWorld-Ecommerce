...
const MenWomenShoesPage = () => {
    const [menWomenShoesdata, setMenWomenShoes] = useState([]);
    ...
    return (
        <>
            ...
            <div style={{ marginTop: '170px' }}>
                <h3 style={{ color: 'darkblue', margin: '20px' }}>Men/Women Shoes</h3>

                <div className="p-3">
                    <Row xs={1} sm={2} md={3} lg={4} className="g-4 mb-4">
                        {menWomenShoesdata.map((item, idx) => {
